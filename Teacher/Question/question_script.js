...
let test_bank = load_info("test_bank", default_tests);
...
$(function() {
<<<<<<< HEAD
	document.querySelector("#save-test-btn").addEventListener("click", function () {save_test_controller()});
	document.querySelector("#teacher-add-question").addEventListener("click", function () {add_question_controller()});
	document.querySelector("#delete-yes").addEventListener("click", function () {popup_remove()});
	document.querySelector("#delete-no").addEventListener("click", function () {popup_keep()});
...
<<<<<<< HEAD
document.querySelector("#back-dashboard-button").addEventListener("click", () => {location.href = "../teacher.html"});
document.querySelector("#question-logout-btn").addEventListener("click", () => {location.href = "../../index.html"});
=======
...
<<<<<<< HEAD
			delete_btn.addEventListener("click", function() { delete_test_controller(delete_btn.firstElementChild.id) });
=======
>>>>>>> 7b92dbdd6763da55aaa321e7de8c273ec0545320
...
<<<<<<< HEAD
			...
			button_col.addEventListener("click", function() { confirm_delete_question(button_col.name, test.name) });
